...
namespace MissionPlanner
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.AirSpeedNeedle);
