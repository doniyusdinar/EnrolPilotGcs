...
namespace MissionPlanner
{
    ...
    {
        #region Fields
        public event System.ComponentModel.PropertyChangedEventHandler HeadingChanged;

        // Parameters
        public int _Heading;
        public int Heading { get { return _Heading; } set { _Heading = value; } } 
        // Images
        Bitmap bmpCadran = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingIndicator_Aircraft);        
        ...
        //add on properties changed method!
        public void OnHeadingChanged(System.ComponentModel.PropertyChangedEventArgs e)
        { 
        //Raise the Heading Change event.
            //Heading = aircraftHeading;

            this.Refresh();
        if (HeadingChanged!= null)
           HeadingChanged(this,e);
