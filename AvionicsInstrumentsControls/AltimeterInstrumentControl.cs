...
namespace MissionPlanner
{
    class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        Bitmap bmpCadran = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Bandeau_Dérouleur);
