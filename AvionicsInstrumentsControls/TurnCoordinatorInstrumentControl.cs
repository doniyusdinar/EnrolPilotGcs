...
namespace MissionPlanner
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.TurnCoordinatorMarks);
