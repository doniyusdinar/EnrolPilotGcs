...
namespace MissionPlanner
{
     class InstrumentControl : System.Windows.Forms.Control
    {
        ...
        public void DisplayRoundMark(PaintEventArgs pe, Image imgMark, InstrumentControlMarksDefinition insControlMarksDefinition, Point ptImg, int radiusPx, Boolean displayText, float scaleFactor)
        {
            Double alphaRot;
            int textBoxLength;
