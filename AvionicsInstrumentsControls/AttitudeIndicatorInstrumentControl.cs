...
namespace MissionPlanner
{
	class AttitudeIndicatorInstrumentControl : InstrumentControl
	{
		...
		public double _PitchAngle=0;
		public double _RollAngle=0;

		public double PitchAngle { get { return _PitchAngle; } set { _PitchAngle = value; } }
		public double RollAngle { get { return _RollAngle; } set { _RollAngle = value; } }

		// Images
		Bitmap bmpCadran = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Horizon_Background);
		Bitmap bmpBoule = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Horizon_GroundSky);
		Bitmap bmpAvion = new Bitmap(MissionPlanner.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Maquette_Avion);
